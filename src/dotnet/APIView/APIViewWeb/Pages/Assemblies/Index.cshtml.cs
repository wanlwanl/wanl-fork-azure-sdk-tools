...
namespace APIViewWeb.Pages.Assemblies
{
    public class IndexPageModel : PageModel
    {
        ...
        public async Task OnGetAsync(
            IEnumerable<string> search = null, IEnumerable<string> languages=null, IEnumerable<string> state =null,
            IEnumerable<string> status =null, IEnumerable<string> type = null, int pageNo=1, int pageSize=_defaultPageSize, string sortField=_defaultSortField)
        {
        ...
        public async Task<PartialViewResult> OnGetReviewsLanguagesAsync(IEnumerable<string> selectedLanguages = null)
        {
