...
namespace APIViewWeb.Repositories
{
    public class ReviewManager
    {
        ...
        public async Task<(IEnumerable<ReviewModel> Reviews, int TotalCount, int TotalPages, int CurrentPage, int? PreviousPage, int? NextPage)> GetPagedReviewsAsync(
            List<string> nameExact, List<string> nameLoose, List<string> author, List<string> prNo, List<string> languages, bool? isClosed, List<int> filterTypes, bool? isApproved, int offset, int limit, string orderBy) 
        {
            var result = await _reviewsRepository.GetReviewsAsync(nameExact, nameLoose, author, prNo, languages, isClosed, filterTypes, isApproved, offset, limit, orderBy);
