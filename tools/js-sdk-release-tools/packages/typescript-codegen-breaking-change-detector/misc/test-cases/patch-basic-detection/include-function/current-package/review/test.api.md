...
export const arrow_function_compatible = (arrow_function_compatible_para_1_current: number) : string;
export const arrow_function_incompatible_1 = (arrow_function_incompatible_1_para_1_current: string) : string;
export const arrow_function_incompatible_2 = (arrow_function_incompatible_2_para_1_current: number) : number;
export const arrow_function_incompatible_3 = (arrow_function_incompatible_3_para_1_baseline: number) : number;
```
