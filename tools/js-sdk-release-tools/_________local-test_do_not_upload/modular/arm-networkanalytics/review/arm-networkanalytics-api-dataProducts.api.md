...
// @public
export function addUserRoleChange(context: NetworkAnalyticsContext, subscriptionId: string, resourceGroupName: string, dataProductName: string, body: RoleAssignmentCommonProperties_2, options?: DataProductsAddUserRoleOptionalParams): Promise<RoleAssignmentDetail_2>;
